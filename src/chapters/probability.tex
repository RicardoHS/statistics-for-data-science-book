...
$X: \Omega \rightarrow \mathbb{R}$ \todo{Write formal definition using borel sigma-algebra}
...
\todo{Add base example that serves as base experiment.} Using this base experiment we cant try to fit other rand. exp. and see
...
\todo{Add base example that serves as base experiment.} Ussing this base experiment we cant try to fit other rand. exp. and see
if this distribution is valid.
\begin{figure}[!ht]
    \begin{minipage}{0.45\linewidth}
