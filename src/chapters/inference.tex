...
<<<<<<< HEAD
\todo[inline]{review the taxonomy and structure to be the same in the whole book}
=======
...
<<<<<<< HEAD
\todo{Add biased section}
=======
\todo[inline]{Write all this, probably it will go in other section}
>>>>>>> master
